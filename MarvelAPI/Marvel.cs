...
namespace FavoriteHero.MarvelAPI
{
    public class Marvel
    {
                                                        ...
                                                        int? Offset = null)
        {
            ...
            string s = String.Format("{0}{1}{2}", timestamp, _privateKey, _publicKey);
            string hash = CreateHash(s);
            string requestURL = String.Format(BASE_URL + "/characters/{3}/comics?ts={0}&apikey={1}&hash={2}&format=comic&formatType=comic&limit=100", timestamp, _publicKey, hash, CharacterId);
        ...
        /// <summary>
        /// Returns a list of Characters for a given Comic
        /// </summary>
        ...
        /// <param name="Limit"></param>
        /// <param name="Offset"></param>
        public async Task<CharacterDataWrapper> GetCharactersForComic(int ComicID,
                                                        string Name = null,
                                                        string nameStartsWith = null,
                                                        IEnumerable<int> Series = null,
                                                        IEnumerable<int> Events = null,
                                                        ...
                                                        int? Offset = null)
        {
            ...
            string s = String.Format("{0}{1}{2}", timestamp, _privateKey, _publicKey);
            string hash = CreateHash(s);
            string requestURL = String.Format(BASE_URL + "/comics/{3}/characters?ts={0}&apikey={1}&hash={2}&limit=100", timestamp, _publicKey, hash, ComicID);
